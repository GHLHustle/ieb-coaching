...
import {
  LayoutDashboard, Users, Map, MessageSquare, Settings, LogOut, Menu, X, Zap, GitBranch, Calendar, BookOpen
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/coach/pipelines', icon: GitBranch, label: 'Pipelines' },
  { to: '/coach/calendar', icon: Calendar, label: 'Calendar' },
  { to: '/coach/blueprints', icon: Map, label: 'Blueprints' },
  { to: '/coach/messages', icon: MessageSquare, label: 'Messages' },
  { to: '/coach/resources', icon: BookOpen, label: 'Resources' },
